...
- When a command or approach is corrected during a conversation, immediately update the relevant doc in `/home/david/github/knowledge` — do not wait to be asked
